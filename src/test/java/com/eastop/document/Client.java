...
public class Client {
	...
	public void testMap(){
		...
		Iterator itd = mapT.entrySet().iterator();
		while (itd.hasNext()) {
			Map.Entry<String, String> mapff = (Entry<String, String>) itd.next();
			System.out.println("Iteratorkey:"+mapff.getKey()+"----Iteratorvalue:"+mapff.getValue());
		}
		
		for(Map.Entry<String, String> mapf : mapT.entrySet()){
			System.out.println("key:"+mapf.getKey()+"----value:"+mapf.getValue());
		}
